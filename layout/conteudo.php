        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li><a href="#sales-chart" data-toggle="tab">Rosquinha</a></li>
          ...
          <div class="box box-success">
            <div class="box-header">
              ...
              <h3 class="box-title">Conversação</h3>
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <div class="item">
                ...
                <p class="message">
                  ...
                  Conte-nos o que achou do template e nos ajude a melhorar, sua experiência de uso é a nossa satisfação!
                </p>
              </div>
              <!-- /.item -->
              <!-- chat item -->
            ...
            <div class="box-body">
              ...
              <ul class="todo-list">
                <li>
                  ...
                  <!-- todo text -->
                  <span class="text">Construa um novo gráfico</span>
                  <!-- Emphasis label -->
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Faça um website responsivo</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Dê brilho ao website</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Forneça Escalabilidade</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Verifique suas notificações</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">Dê suporte ininterrupto</span>
            ...
            <div class="box-body">
              <form action="#" method="post">
                <div class="form-group">
                  <input type="email" class="form-control" name="emailto" placeholder="Enviar para:">
                </div>
                <div class="form-group">
            ...
            <div class="box-footer no-border">
              <div class="row">
                ...
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">Logados</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center">
                  <div id="sparkline-3"></div>
                  <div class="knob-label">Existentes</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
            ...
            <div class="box-footer no-border">
              <div class="row">
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">Por Email</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">Pelo Website</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center">
