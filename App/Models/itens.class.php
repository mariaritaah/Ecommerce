...
Class Itens extends Connect{
    ...
    public function listarItens($idProdutos, $idFabricante){

        $query = "SELECT * FROM `itens`,`fabricante`,`produtos` WHERE (`Fabricante_idFabricante` = `idFabricante` 
        AND `Produto_CodRefProduto` = `CodRefProduto`) 
        AND  (`Fabricante_idFabricante` = '$idFabricante' 
        AND `Produto_CodRefProduto` = '$idProdutos')";
